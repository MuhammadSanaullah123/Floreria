...
const MaterialDetails = () => {
  ...
  const { data, loading } = useAsync(() => MaterialServices.getMaterialById(id));
  console.log(data)
  return (
    <>
      <MainDrawer>
        <MaterialDrawer id={id} />
      </MainDrawer>

      <PageTitle>Material Details</PageTitle>
      {loading ? (
                  ...
                  <p className="text-sm text-gray-500 pr-4">
                    ...
                    {data.status === 'Show' ? (
                      <span className="text-green-400">
                        This Material Showing
                      </span>
                    ) : (
                      <span className="text-red-400"> This Material Hidden</span>
                    )}
                  </p>
                </div>
